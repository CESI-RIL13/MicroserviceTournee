...
<html>
    ...
    <body>
        ...
        <div id="show-trajet" class="content scaffold-show" role="main">
            ...
            <f:display bean="trajet" />
            <g:form resource="${this.trajet}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.trajet}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
